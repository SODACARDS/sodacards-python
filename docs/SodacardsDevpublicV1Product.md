...
**price** | [**SodacardsDevpublicV1Money**](SodacardsDevpublicV1Money.md) | price is what the reseller pays, in FCFA. It is absent when the item is not  yet priced (listed but not purchasable). | [optional] 
**strike_price** | [**SodacardsDevpublicV1Money**](SodacardsDevpublicV1Money.md) | strike_price is an optional reference (pre-discount) price, in FCFA, for  display. Absent when there is none. | [optional] 
