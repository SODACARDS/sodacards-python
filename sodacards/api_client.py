...
from sodacards.configuration import Configuration
from sodacards.api_response import ApiResponse, T as ApiResponseT
import sodacards.models
from sodacards import rest
from sodacards.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sodacards.models, klass)
