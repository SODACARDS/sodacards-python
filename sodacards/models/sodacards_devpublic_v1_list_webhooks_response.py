...
class SodacardsDevpublicV1ListWebhooksResponse(BaseModel):
    """
    SodacardsDevpublicV1ListWebhooksResponse
    """ # noqa: E501
    webhooks: Optional[List[SodacardsDevpublicV1Webhook]] = Field(default=None, description="webhooks are the reseller's registered endpoints.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [SodacardsDevpublicV1Webhook.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
