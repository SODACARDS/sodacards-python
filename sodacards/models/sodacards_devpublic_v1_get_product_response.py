...
class SodacardsDevpublicV1GetProductResponse(BaseModel):
    """
    SodacardsDevpublicV1GetProductResponse
    """ # noqa: E501
    product: Optional[SodacardsDevpublicV1Product] = Field(default=None, description="product is the requested product, priced for the reseller.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "product": SodacardsDevpublicV1Product.from_dict(obj["product"]) if obj.get("product") is not None else None
        })
        return _obj
