...
class SodacardsDevpublicV1RotateWebhookSecretRequest(BaseModel):
    """
    SodacardsDevpublicV1RotateWebhookSecretRequest
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="id is the webhook endpoint whose signing secret to rotate.")
