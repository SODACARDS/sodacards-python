...
class SodacardsDevpublicV1ProductFaceValue(BaseModel):
    """
    ...
    """ # noqa: E501
    amount: Optional[StrictStr] = Field(default=None, description="amount is the face value as an exact decimal string, e.g. \"10.00\".")
    currency: Optional[StrictStr] = Field(default=None, description="currency is the ISO-4217 code of the face value, e.g. \"USD\".")
