...
class SodacardsDevpublicV1RegisterWebhookResponse(BaseModel):
    """
    SodacardsDevpublicV1RegisterWebhookResponse
    """ # noqa: E501
    webhook: Optional[SodacardsDevpublicV1Webhook] = Field(default=None, description="webhook is the registered endpoint.")
    secret: Optional[StrictStr] = Field(default=None, description="secret is the signing secret, shown only once. Store it; verify each delivery  with it. It is never returned again.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhook": SodacardsDevpublicV1Webhook.from_dict(obj["webhook"]) if obj.get("webhook") is not None else None,
