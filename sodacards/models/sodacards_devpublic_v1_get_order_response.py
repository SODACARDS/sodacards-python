...
class SodacardsDevpublicV1GetOrderResponse(BaseModel):
    """
    SodacardsDevpublicV1GetOrderResponse
    """ # noqa: E501
    order: Optional[SodacardsDevpublicV1Order] = Field(default=None, description="order is the requested order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": SodacardsDevpublicV1Order.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
