...
class SodacardsDevpublicV1GetProductRequest(BaseModel):
    """
    SodacardsDevpublicV1GetProductRequest
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="id is the product id, taken from a catalog entry.")
